...
// Shawn: we add this var to indicate Display Number
// all places should use this and avoid to use hardcoded number 2
int _StreamNum_ = 2;
...
bool LiGetCurrentHostDisplayHdrMode(void) { return hdrEnabled; }
