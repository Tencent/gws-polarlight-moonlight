...
extern int g_ConnectPort[ML_PORT_MAX] = {47984,47989,48010,0,0,0,0,0,47998,47999,48000,48010,0,48001};
...
int getTcpPortIndex(int value)
{
    switch (value)
    {
        // TCP ports
    case 47984:
            return ML_PORT_INDEX_TCP_47984;
    case 47989:
            return ML_PORT_INDEX_TCP_47989;
    case 48010:
            return ML_PORT_INDEX_TCP_48010;
    default:
            return 0;
    }
}
int getUdpPortIndex(int value)
{
    ...
    {
    case 47998:
            return ML_PORT_INDEX_UDP_47998;
    case 47999:
            return ML_PORT_INDEX_UDP_47999;
    case 48000:
            return ML_PORT_INDEX_UDP_48000;
    case 48010:
            return ML_PORT_INDEX_UDP_48010;
    case 48002:
            return ML_PORT_INDEX_UDP_48002;
    case 48001:
            return ML_PORT_INDEX_UDP_48001;
    default:
            return 0;
    }
}
...
{
    g_ConnectPort[portFlagIndex] = value;
}
unsigned short LiGetPortFromPortFlagIndex(int portFlagIndex)
{
    if(portFlagIndex < 0 || portFlagIndex >= ML_PORT_MAX)
    {
            return 0;
    }
    return g_ConnectPort[portFlagIndex];
