  ...
  private:
    ...
    static bool isImageBlacklistedA(LPCSTR lpLibFileName) {
        ...
        if (uniChars > 0) {
            ...
            uniChars = MultiByteToWideChar(CP_THREAD_ACP, 0, lpLibFileName, -1, wideBuffer, uniChars * sizeof(WCHAR));
            if (uniChars > 0) {
    ...
    static constexpr LPCWSTR k_BlacklistedDlls[] = {
        ...
        // 05 0000004e`496ffb50 00007ff7`8e30df1e Moonlight!DXVA2Renderer::renderFrame+0x61f
        // [C:\moonlight-qt\app\streaming\video\ffmpeg-renderers\dxva2.cpp @ 1035]
        // 06 0000004e`496ffd50 00007ff7`8e30e46a Moonlight!Pacer::renderFrame+0x3e
        // [C:\moonlight-qt\app\streaming\video\ffmpeg-renderers\pacer\pacer.cpp @ 265]
        // 07 (Inline Function) --------`-------- Moonlight!Pacer::renderLastFrameAndUnlock+0x197
        // [C:\moonlight-qt\app\streaming\video\ffmpeg-renderers\pacer\pacer.cpp @ 156]
        // 08 0000004e`496ffda0 00007ffa`14476978 Moonlight!Pacer::renderThread+0x1ca
        // [C:\moonlight-qt\app\streaming\video\ffmpeg-renderers\pacer\pacer.cpp @ 88]
        // 09 0000004e`496ffde0 00007ffa`14476ee2 SDL2!SDL_RunThread+0x38 [C:\Users\camer\SDL\src\thread\SDL_thread.c @
        // 276]
        // 0a 0000004e`496ffe10 00007ffa`2aae0e82 SDL2!RunThread+0x12
        // [C:\Users\camer\SDL\src\thread\windows\SDL_systhread.c @ 83]
