...
void SdlInputHandler::updateKeyboardGrabState()
{
    ...
    SDL_SetWindowKeyboardGrab(m_Window2, shouldGrab ? SDL_TRUE : SDL_FALSE);
#endif
}
...
bool SdlInputHandler::isSystemKeyCaptureActive()
{
        ...
        )
    {
        ...
        if (m_Window2 == nullptr)
        {
            ...
            qDebug()<<"SdlInputHandler::isSystemKeyCaptureActive() windowFlags2 = "<<windowFlags2;
            {
                qDebug()<<"SdlInputHandler::isSystemKeyCaptureActive()";
                return false;
            }
        }
    }
