...
import Qt.labs.platform 1.0  // 引入
...
ApplicationWindow {
    ...
    property bool newMenuButtonShowFlag: true
    id: window
    visible: true
    width: 1280
    height: 600
    property bool shouldShowMenuBar: true
            ...
            text: {
                switch(Qt.platform.os) {
                    ...
                    {    menuBar.visible = false;
                        return "Running on other platform"
                    }
                }
            }
        }
    ...
    // to allow the user to work with Gleam on a second display
    // while dealing with configuration issues. This will ensure
    // machines come online even if the input focus isn't on Gleam.
    Timer {
        id: inactivityTimer
        interval: 5 * 60000
        onTriggered: {
    ...
    header: ToolBar {
        ...
        RowLayout {
            ...
            NavigableToolButton {
                ...
                onClicked: Qt.openUrlExternally("https://Gleam-stream.org/discord");
            ...
            NavigableToolButton {
                ...
                {
                    ToolTip.text = qsTr("Update available for Gleam: Version %1").arg(version)
            ...
            NavigableToolButton {
                ...
                // TODO need to make sure browser is brought to foreground.
                onClicked: Qt.openUrlExternally("https://github.com/Gleam-stream/Gleam-docs/wiki/Setup-Guide");
    ...
    ErrorMessageDialog {
        ...
        text: qsTr("No functioning hardware accelerated video decoder was detected by Gleam. " +
                   "Your streaming performance may be severely degraded in this configuration.")
        helpText: qsTr("Click the Help button for more information on solving this problem.")
        helpUrl: "https://github.com/Gleam-stream/Gleam-docs/wiki/Fixing-Hardware-Decoding-Problems"
    }
    ...
    NavigableMessageDialog {
        ...
        text: qsTr("This version of Gleam isn't optimized for your PC. Please download the '%1' version of Gleam for the best streaming performance.").arg(SystemProperties.friendlyNativeArchName)
        onAccepted: {
            Qt.openUrlExternally("https://github.com/Gleam-stream/Gleam-qt/releases");
        }
    }
    ...
    ErrorMessageDialog {
        ...
        text: qsTr("Gleam detected gamepads without a mapping:") + "\n" + unmappedGamepads
        helpTextSeparator: "\n\n"
        helpText: qsTr("Click the Help button for information on how to map your gamepads.")
        helpUrl: "https://github.com/Gleam-stream/Gleam-docs/wiki/Gamepad-Mapping"
    }
