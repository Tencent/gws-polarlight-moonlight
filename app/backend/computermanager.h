...
public:
    ...
    void startPolling(QString computerNameOrIp);
    ...
    void pairHost(NvComputer* computer, QString pin, QString token, QString instanceid,
                  QString phost);
...
private:
    void saveHosts();
    bool matchComputerWithName(NvComputer* computer, QString name) const;
