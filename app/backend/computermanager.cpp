...
class RequstGwsPairingTask : public QObject, public QRunnable {
  ...
  public:
    RequstGwsPairingTask(ComputerManager *computerManager, NvComputer *computer, QString pin, QString token,
        ...
        : m_ComputerManager(computerManager), m_Computer(computer), m_Pin(pin), m_Token(token),
...
class PendingPairingTask : public QObject, public QRunnable {
  ...
  public:
    PendingPairingTask(ComputerManager *computerManager, NvComputer *computer, QString pin)
        : m_ComputerManager(computerManager), m_Computer(computer), m_Pin(pin) {
...
void ComputerManager::QuitAutoPair() {
    emit quitAutoHttpsPair();
    qDebug() << "auto pair sucess,quit AutoPair.";
}
void ComputerManager::AutoPairError() {
    emit quitAppCompleted(
        tr("Timeout when pairing, please reboot and try again. Contact administrator if fail again."));
}
