...
MappingFetcher::MappingFetcher(QObject *parent) : QObject(parent), m_Nam(this) {
    ...
    connect(&m_Nam, &QNetworkAccessManager::finished, this, &MappingFetcher::handleMappingListFetched);
}
...
void MappingFetcher::start() {
    ...
    QUrl url("https://Gleam-stream.org/SDL_GameControllerDB/gamecontrollerdb.txt");
